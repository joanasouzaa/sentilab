...
export default function LoginPage() {
    ...
    const handleCadastro = async (e)=>{
        ...
        const response = await fetch('hht')
    }
                ...
                <div className="container flex-1 flex items-center py-12">
                    <div className="mx-auto w-full max-w-md space-y-8 items-center justify-center">
                        ...
                        <div className="space-y-4">
                            ...
                            <button className="border-[#D97C2B] w-full h-16 text-lg justify-start border-1 rounded-sm cursor-pointer" onClick={() => navigate("/login/professor")}>Entrar como Professor </button>

                            <button className="border-[#D97C2B] w-full h-16 text-lg justify-start border-1 rounded-sm cursor-pointer" onClick={() => navigate("/login/aluno")}>Entrar como Aluno</button>
                        </div>
